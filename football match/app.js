...
var maindiv = document.getElementById('teamlist');
...
var divText = document.createTextNode(heading);
divHead.appendChild(divText);
...
for (var key in rounds) {
  ...
  var dayDivText = document.createTextNode(rounds[key].name);
  ...
  for (var key2 in matches) {
    ...
    var li1Text = document.createTextNode(matches[key2].team1 + "===> Score is (" + matches[key2].score.ft[0] + ")");
    li1.appendChild(li1Text);

    var li2 = document.createElement('li');
    var li2Text = document.createTextNode(matches[key2].team2 + "===> Score is (" + matches[key2].score.ft[1] + ")");
